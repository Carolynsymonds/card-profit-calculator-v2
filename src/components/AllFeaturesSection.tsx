import { Sparkles, CheckCircle, Clock, Gift, Settings, Users, BookOpen, Briefcase, FileCheck, ArrowRight, Calendar, Shield, Lightbulb, Brain, Terminal, Database, Layers } from "lucide-react";
