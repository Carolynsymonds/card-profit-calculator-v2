...
const navigationItems = [
  ...
  { title: "AI Fundamentals", url: "/app/fundamentals", icon: Brain },
  { title: "Use Case Library", url: "/app/use-cases", icon: Library },
  { title: "Hands-On Exercises", url: "/app/exercises", icon: Wrench },
