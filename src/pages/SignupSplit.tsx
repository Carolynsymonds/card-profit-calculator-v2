        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Practical AI Skills for Your Kitchen
            </p>
        ...
        <div className="max-w-lg space-y-6 md:space-y-8 bg-white rounded-2xl p-6 md:p-8 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <blockquote className="text-lg text-gray-800 leading-relaxed italic">
              "{siteContent.brand.name} transformed how we run our kitchen. The hands-on AI certification taught us real-time costing and pricing workflows—our bottom line grew 23% in three months."
            </blockquote>
            <div>
